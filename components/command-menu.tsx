...
const commandOptions = [
  {
    ...
    icon: AssignToIcon,
    subOptions: [
      { label: "Air India", icon: PersonIcon },
      { label: "Indigo", icon: PersonIcon },
      { label: "Saudi Air", icon: PersonIcon },
    ],
  },
  {
    label: "Book hotels...",
    ...
    subOptions: [
      { label: "Taj", icon: BacklogIcon },
      { label: "hotel", icon: TodoIcon },
      { label: "xyz hotel", icon: InProgressIcon },
      { label: "more hotel", icon: DoneIcon },
    ],
  },
  {
